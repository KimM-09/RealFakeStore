...
const Cart = () => {
  ...
  return (
    <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      <h1 className='text-3xl font-bold tracking-tight text-gray-900 mv-8'>Shopping Cart</h1>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-x-8 gap-y-10'>
        ...
        <section className='lg:col-span-4 bg-gray-50 rounded-lg p-6 border border-gray-200 self-start'>
            ...
            <button className='mt-6 w-full rounded-md bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-500 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'>
                Proceed to Checkout
            </button>
        </section>
      </div>
